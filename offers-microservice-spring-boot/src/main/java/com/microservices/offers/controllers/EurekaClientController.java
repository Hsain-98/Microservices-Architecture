...
public class EurekaClientController {
    ...
    @RequestMapping("/clienturl/{applicationName}")
    ...
    public @ResponseBody List<ServiceInstance> getClientInstancesByApplicationName(@PathVariable String applicationName) {
